...
def get_optimizer(parameters, optimizer_name):
    optim_params = {}
    ...
    return optim_fn(parameters, **{k: v for k, v in optim_params.items() if k in expected_args})
